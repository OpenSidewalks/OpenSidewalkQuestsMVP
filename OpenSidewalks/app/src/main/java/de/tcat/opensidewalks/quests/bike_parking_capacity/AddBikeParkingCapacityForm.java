...
public class AddBikeParkingCapacityForm extends AbstractQuestFormAnswerFragment
{
									   ...
									   Bundle savedInstanceState)
	{
		...
		View contentView = setContentView(de.tcat.opensidewalks.R.layout.quest_bike_parking_capacity);

		capacityInput = contentView.findViewById(de.tcat.opensidewalks.R.id.capacityInput);
