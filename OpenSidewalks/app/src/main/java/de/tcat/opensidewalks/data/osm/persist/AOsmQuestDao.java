...
public abstract class AOsmQuestDao extends AQuestDao<OsmQuest>
{
	...
	@Override protected String getIdColumnName() { return OsmQuestTable.Columns.QUEST_ID; }
	...
	@Override protected String getQuestStatusColumnName() { return OsmQuestTable.Columns.QUEST_STATUS; }
	@Override protected String getLastChangedColumnName() {	return OsmQuestTable.Columns.LAST_UPDATE; }
