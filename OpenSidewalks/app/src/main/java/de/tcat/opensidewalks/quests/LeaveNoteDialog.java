...
public class LeaveNoteDialog extends DialogFragment
{
	...
	{
		View view = inflater.inflate(de.tcat.opensidewalks.R.layout.leave_note, container, false);

		Button buttonCancel = view.findViewById(de.tcat.opensidewalks.R.id.buttonCancel);
		...
		buttonOk = view.findViewById(de.tcat.opensidewalks.R.id.buttonOk);
		...
		noteInput = view.findViewById(de.tcat.opensidewalks.R.id.noteInput);
	...
	@Override public void onCreate(Bundle inState)
	{
		...
		setStyle(STYLE_NO_TITLE, de.tcat.opensidewalks.R.style.AppTheme_AlertDialog);
	...
	private void onClickOk()
	{
		...
		{
			noteInput.setError(getResources().getString(de.tcat.opensidewalks.R.string.quest_generic_error_field_empty));
			return;
		}
