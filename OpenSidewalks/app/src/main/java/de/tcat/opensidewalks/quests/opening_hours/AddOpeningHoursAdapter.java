...
import de.tcat.opensidewalks.view.dialogs.RangePickerDialog;
...
public class AddOpeningHoursAdapter extends RecyclerView.Adapter
{
		...
		switch (viewType)
		{
			case MONTHS:
				return new MonthsViewHolder(
						inflater.inflate(de.tcat.opensidewalks.R.layout.quest_opening_hours_month_row, parent, false));
			case WEEKDAYS:
				return new WeekdayViewHolder(
						inflater.inflate(de.tcat.opensidewalks.R.layout.quest_opening_hours_weekday_row, parent, false));
		}
		return null;
	}
	...
	private class MonthsViewHolder extends RecyclerView.ViewHolder
	{
		...
		{
			super(itemView);
			monthsText = itemView.findViewById(de.tcat.opensidewalks.R.id.months_from_to);
			delete = itemView.findViewById(de.tcat.opensidewalks.R.id.delete);
										  ...
										  RangePickerDialog.OnRangeChangeListener callback )
	{
		...
		String selectMonths = context.getResources().getString(de.tcat.opensidewalks.R.string.quest_openingHours_chooseMonthsTitle);
	...
	private class WeekdayViewHolder extends RecyclerView.ViewHolder
	{
		...
		{
			super(itemView);
			weekdaysText = itemView.findViewById(de.tcat.opensidewalks.R.id.weekday_from_to);
			hoursText = itemView.findViewById(de.tcat.opensidewalks.R.id.hours_from_to);
			delete = itemView.findViewById(de.tcat.opensidewalks.R.id.delete);
			delete.setOnClickListener(new View.OnClickListener()
			{
				@Override public void onClick(View v)
	...
	private void openSetWeekdaysDialog(final Weekdays weekdays, final WeekdaysPickedListener callback)
	{
		...
		AlertDialog dlg = new AlertDialogBuilder(context)
				.setTitle(de.tcat.opensidewalks.R.string.quest_openingHours_chooseWeekdaysTitle)
	...
	{
		String startLabel = context.getResources().getString(de.tcat.opensidewalks.R.string.quest_openingHours_start_time);
		String endLabel = context.getResources().getString(de.tcat.opensidewalks.R.string.quest_openingHours_end_time);
