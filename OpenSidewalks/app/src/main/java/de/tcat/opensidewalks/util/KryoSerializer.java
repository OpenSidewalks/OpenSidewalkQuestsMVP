...
import de.tcat.opensidewalks.quests.opening_hours.CircularSection;
import de.tcat.opensidewalks.quests.opening_hours.OpeningWeekdays;
...
import de.tcat.opensidewalks.quests.opening_hours.OpeningMonths;
import de.westnordost.osmapi.map.data.Element;
import de.westnordost.osmapi.map.data.OsmLatLon;
import de.westnordost.osmapi.map.data.OsmRelationMember;
import de.westnordost.osmapi.notes.NoteComment;
import de.westnordost.osmapi.user.User;
import de.tcat.opensidewalks.quests.opening_hours.TimeRange;
import de.tcat.opensidewalks.quests.opening_hours.Weekdays;
import de.tcat.opensidewalks.quests.road_name.RoadName;
