...
import de.tcat.opensidewalks.util.JTSConst;
                           ...
                           final Listener listener)
	{
		...
		else
		{
			View inner = LayoutInflater.from(activity).inflate(
					de.tcat.opensidewalks.R.layout.quest_source_dialog_layout, null, false);
			final CheckBox checkBox = inner.findViewById(de.tcat.opensidewalks.R.id.checkBoxDontShowAgain);

			AlertDialogBuilder alertDialogBuilder = new AlertDialogBuilder(activity);
			alertDialogBuilder
					.setTitle(de.tcat.opensidewalks.R.string.quest_source_dialog_title)
					.setView(inner)
