...
public class AboutFragment extends PreferenceFragment
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		getPreferenceScreen().findPreference("repository").setOnPreferenceClickListener(
				new Preference.OnPreferenceClickListener()
				{
					...
					{
						Intent browserIntent = new Intent(Intent.ACTION_VIEW,
								Uri.parse("https://github.com/OpenSidewalks/OpenSideWalkQuests" +
										"" +
										""));
						startActivity(browserIntent);
						return true;
				...
				new Preference.OnPreferenceClickListener()
		{
			...
			{
				Intent browserIntent = new Intent(Intent.ACTION_VIEW,
						Uri.parse("https://github.com/OpenSidewalks/OpenSideWalkQuests/issues"));
				startActivity(browserIntent);
				return true;
			}
		});
				...
				new Preference.OnPreferenceClickListener()
		{
			@Override public boolean onPreferenceClick(Preference preference)
			{
				...
				intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"uwtcat@uw.edu"});
	...
	{
		super.onStart();
		getActivity().setTitle("About OpenSidewalks Quests");
	}
}
