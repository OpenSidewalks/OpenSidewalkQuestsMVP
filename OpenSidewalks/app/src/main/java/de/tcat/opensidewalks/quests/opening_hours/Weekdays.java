...
public class Weekdays
{
	...
	public static String[] getNames(Resources r)
	{
		...
		result[PUBLIC_HOLIDAY] = r.getString(de.tcat.opensidewalks.R.string.quest_openingHours_public_holidays);
		return result;
	}
	...
	public static String[] getShortNames(Resources r)
	{
		...
		result[PUBLIC_HOLIDAY] = r.getString(de.tcat.opensidewalks.R.string.quest_openingHours_public_holidays_short);
		return result;
	}
