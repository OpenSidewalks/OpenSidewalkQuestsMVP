package de.tcat.opensidewalks.quests.toilet_availability;
...
public class AddToiletAvailability extends SimpleOverpassQuestType
{
	...
	@Override public int getIcon() { return de.tcat.opensidewalks.R.drawable.ic_quest_toilets; }
	@Override public int getTitle(@NonNull Map<String, String> tags)
	{
		return de.tcat.opensidewalks.R.string.quest_toiletAvailability_name_title;
	}
}
