...
import de.tcat.opensidewalks.Prefs;
		...
		TouchInput.PanResponder, TouchInput.DoubleTapResponder, CompassComponent.Listener
{
	...
	{
		View view = inflater.inflate(de.tcat.opensidewalks.R.layout.fragment_map, container, false);

		mapView = view.findViewById(de.tcat.opensidewalks.R.id.map);
		TextView mapzenLink = view.findViewById(de.tcat.opensidewalks.R.id.mapzenLink);

		mapzenLink.setText(Html.fromHtml(
				String.format(getResources().getString(de.tcat.opensidewalks.R.string.map_attribution_mapzen),
	...
	@Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
	{
		...
		mapControls = (MapControlsFragment) getChildFragmentManager().findFragmentById(de.tcat.opensidewalks.R.id.controls_fragment);
	...
	protected void initMap()
	{
		...
		BitmapDrawable dot = createBitmapDrawableFrom(de.tcat.opensidewalks.R.drawable.location_dot);
		...
		BitmapDrawable directionImg = createBitmapDrawableFrom(de.tcat.opensidewalks.R.drawable.location_direction);
		...
		accuracyMarker.setDrawable(createBitmapDrawableFrom(de.tcat.opensidewalks.R.drawable.accuracy_circle));
