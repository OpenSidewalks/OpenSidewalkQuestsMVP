...
public class AddWheelchairAccessBusiness extends SimpleOverpassQuestType
{
	...
	@Override public int getIcon() { return de.tcat.opensidewalks.R.drawable.ic_quest_wheelchair_shop; }
	@Override public int getTitle(Map<String, String> tags)
	{
		return de.tcat.opensidewalks.R.string.quest_wheelchairAccess_name_title;
	}
}
