...
public class AddOpeningHoursForm extends AbstractQuestFormAnswerFragment
{
							 ...
							 Bundle savedInstanceState)
	{
		...
		View contentView = setContentView(de.tcat.opensidewalks.R.layout.quest_opening_hours);

		initOpeningHoursAdapter(contentView, savedInstanceState);

		Button addTimes = contentView.findViewById(de.tcat.opensidewalks.R.id.btn_add);
	...
	private void initOpeningHoursAdapter(View contentView, Bundle savedInstanceState)
	{
		...
		RecyclerView openingHoursList = contentView.findViewById(de.tcat.opensidewalks.R.id.opening_hours_list);
	...
	{
		addOtherAnswer(de.tcat.opensidewalks.R.string.quest_openingHours_answer_no_regular_opening_hours, new Runnable()
		{
		...
		addOtherAnswer(de.tcat.opensidewalks.R.string.quest_openingHours_answer_247, new Runnable()
		{
			@Override public void run()
			{
		...
		addOtherAnswer(de.tcat.opensidewalks.R.string.quest_openingHours_answer_seasonal_opening_hours, new Runnable()
		{
			@Override public void run()
			{
	...
	private void onClickAddButton(View v)
	{
		...
		else
		{
			...
			m.getMenu().add(NONE,0,NONE, de.tcat.opensidewalks.R.string.quest_openingHours_add_weekdays);
			m.getMenu().add(NONE,1,NONE, de.tcat.opensidewalks.R.string.quest_openingHours_add_months);
	...
	{
		View view = LayoutInflater.from(getActivity()).inflate(de.tcat.opensidewalks.R.layout.quest_opening_hours_comment, null);
		final EditText editText = view.findViewById(de.tcat.opensidewalks.R.id.commentInput);

		new AlertDialogBuilder(getActivity())
				.setTitle(de.tcat.opensidewalks.R.string.quest_openingHours_comment_title)
				.setView(view)
	...
	{
		new AlertDialogBuilder(getActivity())
				.setMessage(de.tcat.opensidewalks.R.string.quest_openingHours_24_7_confirmation)
