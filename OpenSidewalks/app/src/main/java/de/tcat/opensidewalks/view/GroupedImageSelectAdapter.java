package de.tcat.opensidewalks.view;
...
public class GroupedImageSelectAdapter extends RecyclerView.Adapter<GroupedImageSelectAdapter.ViewHolder>
{
	...
	@Override public GroupedImageSelectAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
	{
		int layoutId = viewType == GROUP ?
				de.tcat.opensidewalks.R.layout.panorama_select_cell : de.tcat.opensidewalks.R.layout.labeled_image_select_cell;
	...
	public class ViewHolder extends RecyclerView.ViewHolder
	{
		...
		{
			super(itemView);
			imageView = itemView.findViewById(de.tcat.opensidewalks.R.id.imageView);
			textView = itemView.findViewById(de.tcat.opensidewalks.R.id.textView);
