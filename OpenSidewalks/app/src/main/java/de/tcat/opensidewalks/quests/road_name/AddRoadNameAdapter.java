...
import de.tcat.opensidewalks.util.DefaultTextWatcher;
...
public class AddRoadNameAdapter extends RecyclerView.Adapter
{
	...
	@Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
	{
		...
		return new ViewHolder(inflater.inflate(de.tcat.opensidewalks.R.layout.quest_roadname_row, parent, false));
	}
	...
	{
		if(languageCode.isEmpty()) return context.getString(de.tcat.opensidewalks.R.string.quest_streetName_menuItem_nolanguage);
		...
		if(displayLanguage.equals(nativeDisplayLanguage))
		{
			return String.format(
					context.getString(de.tcat.opensidewalks.R.string.quest_streetName_menuItem_language_simple),
					languageCode, displayLanguage);
		}
		else
		{
			return String.format(
					context.getString(de.tcat.opensidewalks.R.string.quest_streetName_menuItem_language_native),
	...
	private class ViewHolder extends RecyclerView.ViewHolder
	{
		...
		public ViewHolder(View itemView)
		{
			...
			nameInput = itemView.findViewById(de.tcat.opensidewalks.R.id.nameInput);
			languageButton = itemView.findViewById(de.tcat.opensidewalks.R.id.languageButton);
			deleteButton = itemView.findViewById(de.tcat.opensidewalks.R.id.deleteButton);
			nameSuggestionsButton = itemView.findViewById(de.tcat.opensidewalks.R.id.nameSuggestions);
