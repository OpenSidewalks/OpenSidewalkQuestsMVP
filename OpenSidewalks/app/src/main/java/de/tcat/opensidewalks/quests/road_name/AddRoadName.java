...
import de.tcat.opensidewalks.data.osm.tql.FiltersParser;
import de.tcat.opensidewalks.data.osm.tql.TagFilterExpression;
...
public class AddRoadName implements OsmElementQuestType
{
	...
	@Override public int getIcon() { return de.tcat.opensidewalks.R.drawable.ic_quest_street_name; }
	@Override public int getTitle() { return de.tcat.opensidewalks.R.string.quest_streetName_title; }
