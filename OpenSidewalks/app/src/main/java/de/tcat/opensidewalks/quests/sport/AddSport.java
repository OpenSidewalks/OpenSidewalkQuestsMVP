package de.tcat.opensidewalks.quests.sport;
...
public class AddSport extends SimpleOverpassQuestType
{
	...
	@Override public int getIcon() { return de.tcat.opensidewalks.R.drawable.ic_quest_sport; }
	@Override public int getTitle(Map<String,String> tags)
	{
		return de.tcat.opensidewalks.R.string.quest_sport_title;
	}
}
