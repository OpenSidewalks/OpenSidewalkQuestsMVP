...
public class AddMaxSpeed extends SimpleOverpassQuestType
{
	...
	@Override public int getIcon() { return de.tcat.opensidewalks.R.drawable.ic_quest_max_speed; }
	@Override public int getTitle(Map<String, String> tags)
	{
		return de.tcat.opensidewalks.R.string.quest_maxspeed_title_short;
	}
}
