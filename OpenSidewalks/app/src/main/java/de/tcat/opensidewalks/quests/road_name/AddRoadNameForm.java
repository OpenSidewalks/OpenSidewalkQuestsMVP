...
import de.tcat.opensidewalks.data.meta.Abbreviations;
...
import de.tcat.opensidewalks.data.meta.AbbreviationsByLocale;
...
public class AddRoadNameForm extends AbstractQuestFormAnswerFragment
{
							 ...
							 Bundle savedInstanceState)
	{
		...
		View contentView = setContentView(de.tcat.opensidewalks.R.layout.quest_roadname);
	...
	private void addOtherAnswers()
	{
		...
		addOtherAnswer(de.tcat.opensidewalks.R.string.quest_streetName_answer_noProperStreet, new Runnable()
		{
			@Override public void run()
			{
		...
		addOtherAnswer(de.tcat.opensidewalks.R.string.quest_streetName_answer_cantType, new Runnable()
		{
			@Override public void run()
			{
				showKeyboardInfo();
	...
	private void initRoadNameAdapter(View contentView, Bundle savedInstanceState)
	{
		...
		Button addLanguageButton = contentView.findViewById(de.tcat.opensidewalks.R.id.btn_add);
		...
		RecyclerView recyclerView = contentView.findViewById(de.tcat.opensidewalks.R.id.roadnames);
	...
	@Override protected void onClickOk()
	{
		...
		for (RoadName roadName : adapter.getData())
		{
			...
			{
				Toast.makeText(getActivity(), de.tcat.opensidewalks.R.string.quest_generic_error_a_field_empty,
	...
	private void confirmPossibleAbbreviation(String name, final Runnable onConfirmed)
	{
		String title = String.format(
				getResources().getString(de.tcat.opensidewalks.R.string.quest_streetName_nameWithAbbreviations_confirmation_title_name),
				name);

		new AlertDialogBuilder(getActivity())
				.setTitle(title)
				.setMessage(de.tcat.opensidewalks.R.string.quest_streetName_nameWithAbbreviations_confirmation_description)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_streetName_nameWithAbbreviations_confirmation_positive, new DialogInterface.OnClickListener()
				{
	...
	{
		new AlertDialogBuilder(getActivity())
				.setTitle(de.tcat.opensidewalks.R.string.quest_streetName_cantType_title)
				.setMessage(de.tcat.opensidewalks.R.string.quest_streetName_cantType_description)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_streetName_cantType_open_settings, new DialogInterface.OnClickListener()
				{
					@Override public void onClick(DialogInterface dialog, int which)
					{
				...
				.setNeutralButton(de.tcat.opensidewalks.R.string.quest_streetName_cantType_open_store, new DialogInterface.OnClickListener()
				{
					@Override public void onClick(DialogInterface dialog, int which)
					{
	...
	private void confirmNoStreetName()
	{
		...
		new AlertDialogBuilder(getActivity())
				...
				.setMessage(de.tcat.opensidewalks.R.string.quest_streetName_answer_noName_confirmation_description)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_name_noName_confirmation_positive, onYes)
				.setNegativeButton(de.tcat.opensidewalks.R.string.quest_generic_confirmation_no, onNo)
				.show();
	}
	...
	{
		final String
				linkRoad = getResources().getString(de.tcat.opensidewalks.R.string.quest_streetName_answer_noProperStreet_link),
				serviceRoad = getResources().getString(de.tcat.opensidewalks.R.string.quest_streetName_answer_noProperStreet_service),
				trackRoad = getResources().getString(de.tcat.opensidewalks.R.string.quest_streetName_answer_noProperStreet_track),
				leaveNote = getResources().getString(de.tcat.opensidewalks.R.string.quest_streetName_answer_noProperStreet_leaveNote);
		...
		AlertDialog dlg = new AlertDialogBuilder(getActivity())
				...
				.setTitle(de.tcat.opensidewalks.R.string.quest_streetName_answer_noProperStreet_question)
