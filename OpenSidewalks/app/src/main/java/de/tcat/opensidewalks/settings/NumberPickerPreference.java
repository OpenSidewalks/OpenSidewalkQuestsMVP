		...
		implements NumberPicker.OnValueChangeListener
{
	...
	{
		setDialogLayoutResource(de.tcat.opensidewalks.R.layout.numberpicker_preference);

		final TypedArray a = context.obtainStyledAttributes(attrs,
				de.tcat.opensidewalks.R.styleable.NumberPickerPreference);

		minValue = a.getInt(de.tcat.opensidewalks.R.styleable.NumberPickerPreference_minValue, DEFAULT_MIN_VALUE);
		maxValue = a.getInt(de.tcat.opensidewalks.R.styleable.NumberPickerPreference_maxValue, DEFAULT_MAX_VALUE);
	...
	protected void onBindDialogView(View view) {
		...
		picker = view.findViewById(de.tcat.opensidewalks.R.id.number_picker);
