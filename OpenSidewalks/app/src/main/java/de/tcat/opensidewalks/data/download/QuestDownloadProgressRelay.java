...
import de.tcat.opensidewalks.MainActivity;
...
public class QuestDownloadProgressRelay implements QuestDownloadProgressListener
{
	...
	public QuestDownloadProgressRelay(Service service, int notificationId)
	{
		...
		notificationBuilder = new Notification.Builder(service)
				.setSmallIcon(de.tcat.opensidewalks.R.mipmap.ic_dl_notification)
				.setContentTitle(ApplicationConstants.NAME)
				.setContentText(service.getResources().getString(de.tcat.opensidewalks.R.string.notification_downloading))
