package de.tcat.opensidewalks.quests.max_speed;
...
public class AddMaxSpeedForm extends AbstractQuestFormAnswerFragment
{
	...
	private void setStreetSignLayout(int resourceId)
	{
		...
		speedInput = contentView.findViewById(de.tcat.opensidewalks.R.id.maxSpeedInput);

		View zoneContainer = contentView.findViewById(de.tcat.opensidewalks.R.id.zoneContainer);
	...
	private void initZoneCheckbox(View zoneContainer)
	{
		...
		zoneCheckbox = zoneContainer.findViewById(de.tcat.opensidewalks.R.id.zoneCheckbox);
		...
		zoneContainer.findViewById(de.tcat.opensidewalks.R.id.zoneImg).setOnClickListener(new View.OnClickListener()
		{
	...
	private int getMaxSpeedLayoutResourceId()
	{
		...
		return de.tcat.opensidewalks.R.layout.quest_maxspeed;
	}
	...
	{
		addOtherAnswer(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign, new Runnable()
		{
		...
		{
			addOtherAnswer(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_living_street, new Runnable()
			{
				@Override public void run()
				{
		...
		{
			addOtherAnswer(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_advisory_speed_limit, new Runnable()
			{
				@Override public void run()
				{
	...
	{
		View view = LayoutInflater.from(getActivity()).inflate(de.tcat.opensidewalks.R.layout.quest_maxspeed_living_street_confirmation, null, false);

		ImageView img = view.findViewById(de.tcat.opensidewalks.R.id.imgLivingStreet);
		...
		new AlertDialogBuilder(getActivity())
				.setView(view)
				.setTitle(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_living_street_confirmation_title)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_generic_confirmation_yes,
	...
	{
		View view = LayoutInflater.from(getActivity()).inflate(de.tcat.opensidewalks.R.layout.quest_maxspeed_no_sign_no_slow_zone_confirmation, null, false);

		ImageView imgSlowZone = view.findViewById(de.tcat.opensidewalks.R.id.imgSlowZone);
		Drawable slowZoneDrawable = ((ImageView) getView().findViewById(de.tcat.opensidewalks.R.id.zoneImg)).getDrawable();
		imgSlowZone.setImageDrawable(slowZoneDrawable);

		new AlertDialogBuilder(getActivity())
				.setView(view)
				.setTitle(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_confirmation_title)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_confirmation_positive,
						new DialogInterface.OnClickListener()
						{
							@Override public void onClick(DialogInterface dialog, int which)
							{
	...
	{
		new AlertDialogBuilder(getActivity())
				.setTitle(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_info_urbanOrRural)
				.setMessage(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_urbanOrRural_description)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_urbanOk, new DialogInterface.OnClickListener()
				{
					@Override
				...
				.setNeutralButton(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_ruralOk, new DialogInterface.OnClickListener()
				{
					@Override
					public void onClick(DialogInterface dialog, int which)
					{
	...
	private void confirmNoSign(final Runnable callback)
	{
		new AlertDialogBuilder(getActivity())
				.setTitle(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_confirmation_title)
				.setMessage(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_confirmation)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_maxspeed_answer_noSign_confirmation_positive,
						new DialogInterface.OnClickListener()
						{
							@Override public void onClick(DialogInterface dialog, int which)
	...
	{
		new AlertDialogBuilder(getActivity())
				.setTitle(de.tcat.opensidewalks.R.string.quest_generic_confirmation_title)
				.setMessage(de.tcat.opensidewalks.R.string.quest_maxspeed_unusualInput_confirmation_description)
				.setPositiveButton(de.tcat.opensidewalks.R.string.quest_generic_confirmation_yes, new DialogInterface.OnClickListener()
				{
					@Override
					public void onClick(DialogInterface dialog, int which)
					{
