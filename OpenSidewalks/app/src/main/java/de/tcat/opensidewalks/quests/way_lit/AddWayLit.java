...
public class AddWayLit extends SimpleOverpassQuestType
{
	...
	@Override public int getIcon() { return de.tcat.opensidewalks.R.drawable.ic_quest_lantern; }
	@Override public int getTitle(Map<String,String> tags)
	{
		...
		if (isRoad)
		{
			if (hasName) return de.tcat.opensidewalks.R.string.quest_way_lit_named_road_title;
			else         return de.tcat.opensidewalks.R.string.quest_way_lit_road_title;
		}
		else
		{
			if (hasName) return de.tcat.opensidewalks.R.string.quest_way_lit_named_title;
			else         return de.tcat.opensidewalks.R.string.quest_way_lit_title;
		}
	}
}
