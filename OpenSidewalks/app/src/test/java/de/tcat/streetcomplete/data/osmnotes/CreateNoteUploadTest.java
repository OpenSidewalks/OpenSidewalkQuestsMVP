...
import de.tcat.opensidewalks.data.osmnotes.CreateNote;
import de.tcat.opensidewalks.data.osmnotes.CreateNoteDao;
import de.tcat.opensidewalks.data.osmnotes.CreateNoteUpload;
import de.tcat.opensidewalks.data.osmnotes.NoteDao;
import de.tcat.opensidewalks.data.osmnotes.OsmNoteQuest;
...
public class CreateNoteUploadTest extends TestCase
{
	...
	public void testCreateNoteWithNoQuestTitleButAssociatedElement()
	{
		...
		verify(notesDao).create(createNote.position,
				"for " + CreateNoteUpload.getAssociatedElementString(createNote) + " :\n\n" + createNote.text);
	...
	public void testCreateNoteWithAssociatedElementAndNoNoteYet()
	{
		...
		verify(notesDao).create(createNote.position,
				"Unable to answer \"" + createNote.questTitle + "\"" +
				" for " + CreateNoteUpload.getAssociatedElementString(createNote) +
